...
invM(uu::u.LengthUnits, d::AbstractMassProfile, x::Real) = invM(d, x) * defaultunits.mass |> uu
...
invMproj(uu::u.LengthUnits, d::AbstractMassProfile, x::Real) = invMproj(d, x) * defaultunits.mass |> uu
